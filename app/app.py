...
class App(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet(
            "background-color: #1a1a1a; color: white; font-family: 'Segoe UI';"
        )
        ...
        self.conn_label.setStyleSheet(
            "background-color: #333; padding: 5px; border-radius: 5px;"
        )
        ...
        data_panel.setStyleSheet(
            "background-color: #262626; border-radius: 10px; padding: 10px;"
        )
        ...
        self.trg_display.setStyleSheet(
        ...
        self.btn_status.setStyleSheet(
            "background-color: #2ecc71; color: white; padding: 15px; border-radius: 10px; margin-top: 10px;"
        )
    ...
    def read_data(self):
        ...
        try:
            if self.ser.in_waiting > 0:
                ...
                for part in parts:
                    ...
                    # Obsługa przycisku (nadpisuje kolor i tekst labela BTN)
                        ...
                        if "1" in state:
                            ...
                            self.btn_status.setStyleSheet(
                                "background-color: red; color: white; font-weight: bold; border-radius: 10px;"
                            )
                        else:
                ...
                if (
                    received_trg is not None
                    and abs(received_trg - self.current_trg) > 0.1
                ):
                    self.send_frame()
